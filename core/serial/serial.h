...
namespace core {
    ...
    namespace serial {
        ...
        typedef enum {
            ...
            stopbits_one_point_five = 3  /*!< 1.5 stop bits */
        } stopbits_t;
        ...
        typedef enum {
            ...
            flowcontrol_software, /*!< Software (XON/XOFF) flow control */
            flowcontrol_hardware  /*!< Hardware (RTS/CTS) flow control */
        } flowcontrol_t;
...
#undef max
        ...
        class Serial: public ChannelDevice {
          public:
            ...
            /// \return
            ///
            virtual const char *DescribeError() { return DescribeError(getSystemError()); };
          ...
          private:
            ...
            class SerialImpl;
            std::shared_ptr<SerialImpl> pimpl_;
            ...
            void SetSerialPortError(SerialPortError error) { m_serialErrno = error; };
        };
