...
namespace core {
    ...
    namespace serial {
        ...
        class Serial::ScopedReadLock {
          public:
            explicit ScopedReadLock(std::shared_ptr<Serial::SerialImpl> pimpl) : pimpl_(pimpl) { this->pimpl_->readLock(); }
          ...
          private:
            ...
            std::shared_ptr<Serial::SerialImpl> pimpl_;
        };

        class Serial::ScopedWriteLock {
          public:
            explicit ScopedWriteLock(std::shared_ptr<Serial::SerialImpl> pimpl) : pimpl_(pimpl) { this->pimpl_->writeLock(); }
        ...
        Serial::Serial(const string   &port,
            ...
            pimpl_ = std::make_shared<SerialImpl>(port, baudrate, bytesize, parity, stopbits, flowcontrol);
